...
class ChurnPrediction(QwakModelInterface):
    ...
    def build(self):
        ...
        print('Simple model validation accuracy: {:.4}'.format(accuracy_score(y_validation, y_predicted)))
        print('Best model validation accuracy: {:.4}'.format(accuracy_score(y_validation, y_predicted)))
